...
- [🤖 Prompt para Agente de IA](#-prompt-para-agente-de-ia)
- [Como usar (Python)](#como-usar)
...
Se você tiver um agente de IA configurado com as skills deste projeto, basta enviar:

```
Gere a Missa "Nome da Missa"
```

> ⚠️ O nome da Missa deve estar **entre aspas** e ser **exatamente igual** ao valor cadastrado no campo `Missa` do Notion.

**Exemplos de prompts válidos:**
```
Gere a Missa "Quaresma I"
Gere a Missa "Quaresma II"
Gere a Missa "Cinzas"
Gere a Missa "Comum I"
```
