...
### 13. Liturgical / Church

**Vibe:** Timeless, sacred, highly-legible

**Typography:** `Cormorant Garamond` + `Source Serif 4` (Large Base: ~42px / `clamp(1.5rem, 3.5vw, 2.625rem)`)

**Colors:** Warm cream (#faf9f7), charcoal text (#1a1a1a), crimson accent (#c41e3a)

**Signature:** Alternating Chorus/Stanza slides, large typography, vertical rhythm, high contrast.
...
| Liturgical / Church | Cormorant Garamond | Source Serif 4 | Google |
